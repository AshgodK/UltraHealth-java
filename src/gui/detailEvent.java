...
private String password = "degfppsysconhzft";
 ...
 @FXML
   ...
   public void buyP() throws IOException
       {
          ...
          // float priceE= Float.parseFloat(PriceCell);
           ...
           String to=pass.getMail(ConnectionController.idU);
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
           ...
           Alert alert = new Alert(Alert.AlertType.WARNING, "Veuillez Entrez votre mail.");
            ...
            //EvennementServ ev = new EvennementServ();
             ...
             pass.AjouterP(newP, EvennementFrontController.Ove,ConnectionController.idU);
   ...
   {
        try {
            Rectangle pageSize = new Rectangle(300, 220);
            pageSize.setBackgroundColor(new BaseColor(	0x0, 0xCE, 0xD1));
    ...
    blueFont.setColor(BaseColor.BLUE);
        ...
        image.setAbsolutePosition(0, 170);
        document.add(image);
